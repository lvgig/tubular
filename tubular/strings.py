    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the instance with columns, target column name and the pd.Series.str method to use for the transformation."""
...
class StringConcatenator(BaseTransformer):
    ...
    def __init__(self, columns, new_column="new_column", separator=" ") -> None:
        """Initialize the instance with columns to concatenate, separartor between valuesa and name of the new column."""
